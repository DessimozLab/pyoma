...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Update cached/precomputed data for browser")
    ...
    parser.add_argument("-c", "--cache-file", default=None, help="Path to a temporary cache file")
    parser.add_argument(
        "-f",
        "--overwrite",
        action="store_true",
