...
def get_test_data():
    return (np.array([(1, 1, 251.32, 22.4, 9.11, 422, True, False, True),
...
class GenomePairTest(unittest.TestCase):
    ...
    def test_get_entry(self):
        ...
        self.assertEqual([(1, 1), (1, 5), (1, 6)], prot1_matches, "unexpected matches with ALL selector")
        ...
        self.assertEqual(0, len(self.genome_pair[3]['ALL'].relations()),
